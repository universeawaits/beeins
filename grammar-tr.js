...
const GRAMMAR = [
 {
  ...
  "intro": {
   ...
   "de": "Im Türkischen hat der Vokal einer Endung keine feste Form — er richtet sich nach dem LETZTEN Vokal des Wortes, weshalb ein und dieselbe Endung mal so, mal anders geschrieben wird (evler, aber okullar). Es gibt zwei Mechanismen: Die zweistufige Harmonie wählt zwischen e und a (nach e/i/ö/ü kommt e, nach a/ı/o/u kommt a). Die vierstufige wählt aus i/ı/u/ü und beachtet zusätzlich die Lippenrundung: Nach einem gerundeten Vokal (o, u, ö, ü) folgt ein gerundetes u oder ü (okul → okulu, göz → gözü). Ein deutsches Gegenstück gibt es nicht — im Deutschen ändert -e oder -en seinen Vokal nie —, also immer zuerst den letzten Vokal suchen, dann die Endung anhängen.",
   "ar_sy": "بالتركي حركة اللاحقة ما إلها شكل ثابت — بتتغيّر حسب آخر حركة بالكلمة، مشان هيك نفس اللاحقة بتنكتب بأكتر من شكل (evler بس okullar). في آليتين: التناغم الثنائي بيختار بين e وa (بعد e/i/ö/ü بتجي e، وبعد a/ı/o/u بتجي a). والتناغم الرباعي بيختار من i/ı/u/ü وكمان بينتبه ع تدوير الشفاه: بعد الحركة المدوّرة (o، u، ö، ü) بتجي u أو ü مدوّرة (okul → okulu، göz → gözü). هالشي ما إلو مقابل بالعربي، لأنو اللاحقة بالعربي ما بتتبدّل حسب حركة الجذر، فدايماً أول شي دوّر ع آخر حركة، وبعدين ضيف اللاحقة."
  },
  "tables": [
   {
    "caption": {
  ...
  "hints": {
   ...
   "de": "Anders als im Deutschen, wo Endungen wie -e/-en immer gleich bleiben, entscheidet im Türkischen der letzte Vokal über 2 oder 4 mögliche Formen. Drei typische Fehler von Deutschsprachigen: (1) ı (ohne Punkt) und i (mit Punkt) werden verwechselt — das sind zwei verschiedene Buchstaben und Laute, kein Schreibversehen; (2) in der vierstufigen Harmonie wird die Lippenrundung vergessen und nach o/u/ö/ü fälschlich i/ı statt u/ü gesetzt (falsch okuli statt okulu); (3) das deutsche ü/ö wird zwar mühelos ausgesprochen, aber nicht als Steuervokal erkannt — genau diese Paare o/ö und u/ü bestimmen hier die Endungsform. Reihenfolge immer gleich: erst den letzten Vokal finden, dann anhängen.",
   "ar_sy": "بالعربي اللاحقة ما بتتغيّر حسب حركة الكلمة، بس بالتركي آخر حركة هي يلي بتقرّر أي شكل من الـ2 أو الـ4 رح تاخد اللاحقة. تلات غلطات بيعملوها العرب كتير: (1) بيخلطوا بين ı (بلا نقطة) وi (بنقطة) — دول حرفين وصوتين مختلفين مو نفس الشي؛ (2) بالتناغم الرباعي بينسوا التدوير وبعد o/u/ö/ü بيحطوا i/ı بدل u/ü (غلط okuli، الصح okulu)؛ (3) أصوات ö وü وı مو موجودة بالعربي فبيبدلوها بـ o أو u أو i عادية وبيخربوا التناغم. الترتيب دايماً هو نفسو: أول شي لاقي آخر حركة، وبعدين ضيف اللاحقة."
  }
 },
 {
  ...
  "intro": {
   ...
   "de": "Im Türkischen wird ein hartes p, ç, t, k am Wortende weich (p→b, ç→c, t→d, k→ğ), sobald ein Suffix folgt, das mit einem Vokal beginnt — und anders als im Deutschen wird diese Änderung auch geschrieben: kitap → kitabı, kağıt → kağıdı, ekmek → ekmeği (nicht „kitapı\"). Am häufigsten trifft man das im Akkusativ, Genitiv und Dativ, also genau dort, wo im Deutschen der Fall nur den Artikel verändert und das Substantiv gleich bleibt. Getrennt davon gibt es eine Angleichung im Suffix selbst: -de/-te und -den/-tan beginnen nach einem stimmlosen Konsonanten mit t, sonst mit d.",
   "ar_sy": "بالتركي الحرف القاسي بآخر الكلمة (p, ç, t, k) بيلين لما تجي لاحقة بتبدأ بحرف علة: p→b، ç→c، t→d، k→ğ — والفرق المهم إنو التغيير بينكتب مو بس بينلفظ: kitap → kitabı، kağıt → kağıdı، ekmek → ekmeği (مو „kitapı\"). أكتر شي رح تشوف هالشي بحالة المفعول والإضافة والاتجاه، يعني بالمحلات يلي بالعربي منحطلها لاحقة أو حرف جر بس جذر الكلمة بيضل متل ما هو. وفي كمان تناغم داخل اللاحقة نفسها: ‑de/‑te و‑den/‑tan بيبدوا بـ t بعد حرف مهموس، وبـ d بغير هيك."
  },
  "tables": [
   {
    "caption": {
  ...
  "hints": {
   ...
   "de": "Der deutsche Reflex ist die Auslautverhärtung — wir sprechen „Tag\" wie „Tak\", aber im Schriftbild bleibt das g; das Türkische macht vor einem Vokal genau das Gegenteil und schreibt die Erweichung mit: kitabı, kağıdı, ekmeği, die Form „kitapı\" ist falsch. Vorsicht bei der Suffixwahl: nach stimmlosem p, ç, t, k, s, ş, h, f heißt es -te/-ten (sokakta, uçaktan), sonst -de/-den (evde, evden). Und nicht jedes Wort erweicht — viele kurze Wörter bleiben hart (at → atı, top → topu), im Zweifel im Wörterbuch prüfen.",
   "ar_sy": "بالعربي جذر الكلمة ما بيتغيّر لما تزيد عليها، فالخطأ الشائع إنك تكتب الحرف الأخير متل ما هو؛ بس بالتركي القاسي بيلين قدام حرف العلة والتغيير لازم ينكتب: kitabı، kağıdı، ekmeği — „kitapı\" غلط. وانتبه للاحقة: بعد الحروف المهموسة p, ç, t, k, s, ş, h, f بتستعمل ‑te/‑ten (sokakta, uçaktan)، وبغير هيك ‑de/‑den (evde, evden). وما كل الكلمات بتلين — كتير كلمات قصيرة بتضل قاسية (at → atı، top → topu)، فالأفضل تتأكد من القاموس."
  }
 },
 {
  "id": "plural",
  ...
  "intro": {
   ...
   "de": "Anders als im Deutschen, wo der Plural völlig unvorhersehbar ist (Buch → Bücher, Haus → Häuser, Auto → Autos, Kind → Kinder – mal Umlaut, mal -er, mal -s), kennt das Türkische nur EIN einziges Pluralzeichen, das ans Wortende gehängt wird: -lar oder -ler. Der Wortstamm ändert sich nie, es gibt keinen Umlaut und kein grammatisches Geschlecht. Welche der beiden Formen du nimmst, entscheidet allein der letzte Vokal des Wortes (Vokalharmonie – dafür gibt es im Deutschen keine Entsprechung): nach den hinteren Vokalen a, ı, o, u kommt -lar (kitap → kitaplar), nach den vorderen e, i, ö, ü kommt -ler (ev → evler). Und merk dir gleich die wichtigste Besonderheit: nach einer Zahl oder nach çok („viele\") bleibt das Nomen im Singular – der Türke sagt wörtlich „drei Buch\", nicht „drei Bücher\".",
   "ar_sy": "بالعكس عن العربي، يلي فيه المفرد والمثنى وجمع تكسير كتير وأشكال ما بتتوقعها (كتاب → كتب، بيت → بيوت، ولد → ولاد)، بالتركي في لاحقة جمع وحدة بس بتلزق بآخر الكلمة: -lar أو -ler. جذر الكلمة ما بيتغير أبداً، ما في تكسير، وما في مذكّر ومؤنث بالتركي أصلاً. أي وحدة بتختار بيقررها بس الحرف المتحرك الأخير بالكلمة (تناغم الحركات، وهاد شي ما إلو مثيل بالعربي): بعد الحركات الخلفية a, ı, o, u بتحط -lar (kitap → kitaplar)، وبعد الأمامية e, i, ö, ü بتحط -ler (ev → evler). وخليك منتبه لأهم شي: بعد الرقم أو بعد çok («كتير») الاسم بيضل مفرد – التركي بيقول حرفياً «تلات كتاب» مو «تلات كتب»."
  },
  "tables": [
   {
    "caption": {
  ...
  "hints": {
   ...
   "de": "Türkisch hat nur EIN regelmäßiges Pluralzeichen (-lar/-ler), und seine Form hängt allein von der Vokalharmonie ab – vergiss deinen deutschen Reflex, für jedes Wort eine eigene Pluralform (Umlaut, -er, -en, -s) zu suchen. Der klassische Fehler deutscher Lernender kommt aber vom Zählen: „drei Bücher\", „viele Häuser\" stehen im Deutschen im Plural, im Türkischen bleibt das Nomen nach einer Zahl und nach çok („viele\") im Singular – sag „üç kitap\" (drei Buch) und „çok araba\", niemals „üç kitaplar\". Und wähl -lar/-ler streng nach dem letzten Vokal, nicht nach dem Klang oder dem Geschlecht, das es im Türkischen gar nicht gibt.",
   "ar_sy": "بالتركي في لاحقة جمع وحدة بس (-lar/-ler) وشكلها بيتحدد من تناغم الحركات، ما في مثنى ولا جمع تكسير متل العربي – فانسى فكرة إنو كل كلمة إلها جمع خاص فيها. أكبر غلط بيعملو العربي إنو بيحطو الجمع بعد الرقم، لأنو بالعربي مننقول «تلات كتب» و«كتير بيوت»، بس التركي بعد الرقم وبعد çok («كتير») بيضل الاسم مفرد – قول «üç kitap» (تلات كتاب) و«çok araba»، ومنشان الله مو «üç kitaplar». وكمان اختار -lar أو -ler حسب الحرف المتحرك الأخير بس، مو حسب المعنى أو الجنس لأنو ما في مذكّر ومؤنث بالتركي."
  }
 },
 {
  "id": "pronouns",
  ...
  "intro": {
   ...
   "de": "Das Türkische hat sechs Personalpronomen: ben (ich), sen (du), o (er/sie/es — ohne Geschlecht), biz (wir), siz (ihr/Sie), onlar (sie). Anders als im Deutschen, wo die Rolle über Artikel, Kasusflexion und Präpositionen läuft (mir, bei mir, von mir), klebt das Türkische die Kasusendung direkt ans Wort: beni (mich), bana (mir), bende (bei mir), benden (von mir) — alles ein Wort, keine Präposition. Das Türkische hat sechs Fälle (zwei mehr als das Deutsche: Lokativ und Ablativ), und o trägt kein grammatisches Geschlecht, ist also zugleich \"er\", \"sie\" und \"es\". Merken Sie sich die Ausnahmen: Dativ bana/sana (nicht \"bene/sene\") und Genitiv benim/bizim mit -im statt des erwarteten -in.",
   "ar_sy": "بالتركي في ٦ ضمائر: ben (أنا)، sen (إنت)، o (هو/هي، بلا تذكير وتأنيث)، biz (نحنا)، siz (إنتو)، onlar (هنّي). دور الضمير بالجملة ما بيبيّن بحرف جر متل العربي (إلي، عندي، مني)، بيبيّن بلاحقة بتلزق عآخر الكلمة: beni (إياي)، bana (إلي)، bende (عندي)، benden (مني) — كل وحدة كلمة واحدة بلا حرف جر. وانتبه للشواذ: الاتجاه bana/sana (مو \"bene/sene\")، والإضافة (الملكية) benim/bizim بـ -im بدل الـ -in يلي بتتوقعها."
  },
  "tables": [
   {
    "caption": {
  ...
  "hints": {
   ...
   "de": "Deutsche suchen bei o instinktiv nach einem Geschlecht und greifen für \"bei mir/von mir\" zu Präpositionen — im Türkischen steckt beides im Wort: bende = \"bei mir\", benden = \"von mir\", und o deckt \"er/sie/es\" allein ab. Der häufigste Fehler ist \"bene/sene\"; richtig ist nur bana/sana, und \"mein/dein\" ist die eigene Form benim/senin. Das Subjektpronomen lässt man meist weg (Öğretmenim = \"Ich bin Lehrer\"), weil die Verbendung die Person schon zeigt — ben, sen nur zur Betonung.",
   "ar_sy": "أكبر غلط بيعملو العرب إنن يدوّرو على تذكير وتأنيث بـ o، بس هي كلمة وحدة للـ\"هو\" وللـ\"هي\" سوا. وبيحاولو يزيدو كلمة للجر متل \"عند/من\"، بس \"عندي\" = bende و\"مني\" = benden، كلها بلاحقة. وتذكّر: الصح bana/sana مو \"bene/sene\"، و\"إلي/إلك\" (الملكية) شكل تاني: benim/senin. وضمير الفاعل بينحذف كتير (Öğretmenim = \"أنا معلّم\") لأن آخر الفعل عم يبيّن مين الشخص — حط ben أو sen بس للتأكيد."
  }
 },
 {
  "id": "to-be",
  ...
  "intro": {
   ...
   "de": "Im Türkischen gibt es im Präsens kein eigenständiges Verb \"sein\" wie das deutsche bin/bist/ist — seine Rolle übernimmt eine Personalendung, die ans Ende des Prädikats geklebt wird: Ben öğretmenim heißt \"Ich bin Lehrer\". Anders als im Deutschen steht das Wort für \"ich, du\" also gewissermaßen doppelt (einmal als Pronomen, einmal in der Endung), und die Endung richtet sich nach der Vokalharmonie (-ım/-im/-um/-üm) — dafür gibt es im Deutschen keine Entsprechung. In der 3. Person fehlt die Endung meist ganz (o hasta = \"er ist krank\"). Verneint wird mit dem eigenen Wort değil NACH dem Adjektiv (hasta değilim), und für \"es gibt / es gibt nicht\" benutzt man nicht die Endung, sondern die Wörter var und yok, die ganz ans Satzende wandern.",
   "ar_sy": "بالتركي ما في فعل كون مستقل بالمضارع متل ما بالعربي الجملة الاسمية بتمشي بلا فعل؛ محلّو في لاحقة شخص بتنلزق بآخر الكلمة: Ben öğretmenim يعني \"أنا مْعَلِّم\". يعني لازم تحط اللاحقة حتى لو حطّيت الضمير، وهي اللاحقة بتتغيّر حسب انسجام الحركات (-ım/-im/-um/-üm) وهاد شي ما إلو مثيل بالعربي. بصيغة الغائب (هو/هي) غالباً اللاحقة بتنحذف (o hasta = \"هو مريض\"). النفي بيصير بكلمة مستقلة değil بتجي بعد الصفة (hasta değilim)، ولَتقول \"في / ما في\" ما بتستعمل اللاحقة، بتستعمل var و yok وبيروحو بآخر الجملة."
  },
  "tables": [
   {
    "caption": {
  ...
  "hints": {
   ...
   "de": "Der Hauptfehler deutscher Lerner ist, das \"sein\" wie im Deutschen als eigenes Wort VOR das Adjektiv zu setzen (*ben bin hasta) — im Türkischen wird die Endung ANS Wortende geklebt (hastayım) und in der 3. Person meist ganz weggelassen (o hasta, nicht *o hastadır im Alltag). Zweite Falle: Es gibt zwei verschiedene \"nicht\" — \"er ist nicht krank\" ist hasta değil, aber \"es gibt keine Milch\" ist süt yok, niemals *süt değil. Und denken Sie daran: var/yok und die Fragepartikel mı/mi stehen immer am Satzende, nicht wie im Deutschen mitten im Satz.",
   "ar_sy": "أكبر غلط بيعملو العرب إنهم ينسو لاحقة الشخص، لأنو بالعربي الجملة الاسمية بتمشي بلا فعل (بنقول \"أنا مريض\" بلا شي)، بس بالتركي لازم تقول hastayım مو بس hasta. الفخ التاني إنو في نفيين مختلفين: \"هو مو مريض\" بتصير hasta değil (değil بعد الصفة)، بس \"ما في حليب\" بتصير süt yok مو *süt değil أبداً! وتذكّر: var/yok وأداة السؤال mı/mi دايماً بيروحو بآخر الجملة، مو بالنص."
  }
 },
 {
  ...
  "intro": {
   ...
   "de": "Die Endung -(ı)yor ist die wichtigste Alltagszeit des Türkischen: Sie steht sowohl für etwas, das gerade jetzt passiert („ich lese gerade\") als auch für Gewohnheiten („ich lese jeden Tag\") — eine einzige Form deckt beides ab, ähnlich wie das deutsche Präsens. Sie wird an den Verbstamm angehängt: Endet der Stamm auf einen Konsonanten, kommt nach der Vokalharmonie ein Bindevokal ı/i/u/ü dazu (yap-ı-yor, gel-i-yor); endet er auf einen Vokal, entfällt dieser (oku-yor). Das -yor selbst bleibt dabei immer unverändert. Anders als im Deutschen, wo die Person in der Verbendung steckt, wird sie hier als eigene Silbe hinten angeklebt (agglutinierend): -um, -sun, -uz usw.",
   "ar_sy": "لاحقة -(ı)yor هي أهم زمن بالتركي بالحياة اليومية: بتعبّر عن شي عم يصير هلق (\"عم اقرا هلق\") وكمان عن العادة (\"كل يوم بقرا\") — نفس الصيغة بتغطّي التنتين، ما في زمنين منفصلين متل العربي. بتنلزق بجذر الفعل: إذا الجذر بينتهي بحرف ساكن بينضاف حرف وصل ı/i/u/ü حسب انسجام الحركات (yap-ı-yor، gel-i-yor)، وإذا بينتهي بحركة ما منزيد شي (oku-yor)، والـ -yor بحد ذاتو بيضل ما بيتغيّر. وفي فرق كبير عن العربي: بالتركي ما في مذكّر ومؤنّث بالفعل — \"هو\" و\"هي\" بياخدو نفس الصيغة (geliyor)، ومنحط لاحقة الشخص بآخر الكلمة بدل ما نغيّر أوّل الفعل متل العربي."
  },
  "tables": [
   {
    "caption": {
  ...
  "hints": {
   ...
   "de": "Suchen Sie keine zweite Zeitform für Gewohnheiten — anders als im Englischen deckt -(ı)yor „ich lese\" und „ich lese gerade\" gemeinsam ab. Zwei typische Fehler Deutschsprachiger: (1) Die Vokalharmonie hat im Deutschen keine Entsprechung — es ändert sich nur der Bindevokal (yapıyor, geliyor, okuyor, görüyor), das -yor bleibt immer -yor. (2) Endet der Stamm auf -a/-e, wird dieser Vokal zu ı/i/u/ü: bekle- → bekliyor, başla- → başlıyor, yıka- → yıkıyor.",
   "ar_sy": "ما تدوّر على زمنين متل العربي (بروح / رايح) — نفس الـ -(ı)yor بتعمل الشغلتين. غلطتين شائعات عند العرب: (1) لا تأنّث الفعل — \"هي\" بتصير geliyor تماماً متل \"هو\"، ما في بتروح مقابل بيروح؛ (2) اللي بيتغيّر بس حرف الوصل حسب انسجام الحركات (yapıyor، geliyor، okuyor، görüyor)، أما -yor بيضل متل ما هو. وانتبه: إذا الجذر بينتهي بـ a/e بتنقلب لـ ı/i/u/ü: bekle- → bekliyor، başla- → başlıyor."
  }
 },
 {
  "id": "possessive",
  ...
  "intro": {
   ...
   "de": "Wo das Deutsche Possessivpronomen benutzt, die sich nach Genus, Numerus und Kasus richten (mein Haus, meine Tasche, meines Hauses), klebt das Türkische die Zugehörigkeit direkt als Suffix ans Nomen: evim (mein Haus), evin (dein Haus), evi (sein/ihr Haus) — kein grammatisches Geschlecht, kein Artikel. Der Vokal des Suffixes folgt der Vokalharmonie, die es im Deutschen nicht gibt: ev → evim, aber okul → okulum und göz → gözüm. Nennt man einen konkreten Besitzer, wird DOPPELT markiert: der Besitzer bekommt -in (Ali'nin) und die Sache das Possessivsuffix (evi) → Ali'nin evi, wörtlich „von-Ali sein-Haus\". Das Deutsche markiert dagegen nur einmal, nämlich am Besitzer (das Buch des Lehrers).",
   "ar_sy": "بالتركي، متل العربي، الملكية بتنلزق بآخر الاسم كلاحقة: evim (بيتي)، evin (بيتك)، evi (بيتو) — بس في فرق مهم: ما في مذكر ومؤنث متل العربي (evi بتعني بيتو وبيتها سوا)، وما في أل التعريف. حرف العلة بالاحقة بيتبع الانسجام الصوتي، وهاد شي ما إلو مثيل بالعربي: ev → evim بس okul → okulum وgöz → gözüm. ولمّا بدك تحكي مين صاحب الشي بتنعكس عادة العربي: بالعربي منقول \\\"بيت علي\\\" (الشي أول وما في علامة عالصاحب)، أما بالتركي الصاحب بيجي أول وبياخد -in والشي بياخد لاحقة الملكية: Ali'nin evi."
  },
  "tables": [
   {
    "caption": {
  ...
  "hints": {
   ...
   "de": "Typische Falle: Deutschsprachige übertragen ihren Genitiv und sagen nur „Ali'nin ev\" — die Sache MUSS aber ihr eigenes Suffix behalten: Ali'nin evi (beide Teile markiert). Umgekehrt lässt man das Wort benim/senin oft stehen, weil man ein Possessivpronomen gewohnt ist — überflüssig, denn das Suffix am Nomen zeigt die Person schon (evim genügt). Und nach einem Vokal kommt der Bindekonsonant -s-: araba → arabası, nicht „arabaı\".",
   "ar_sy": "أكبر غلط بيوقع فيه العربي هو بتركيب متل \\\"بيت علي\\\": لأنو بالعربي منحط علامة وحدة بس، بينسى يحط لاحقة عالشي وبيقول غلط \\\"Ali'nin ev\\\" — الصح Ali'nin evi، لازم العلامتين مع بعض. وانتبه للترتيب: بالتركي الصاحب بيجي أول، مو تاني متل العربي. ومتل ما بالعربي بدك حرف وصل، بالتركي بعد حرف العلة لازم -s-: araba → arabası مو arabaı."
  }
 },
 {
  "id": "past-definite",
  ...
  "intro": {
   ...
   "de": "Die bestimmte Vergangenheit bezeichnet abgeschlossene Handlungen, die der Sprecher selbst gesehen, erlebt oder sicher weiß. Anders als im Deutschen, wo das Perfekt zwei Wörter mit Hilfsverb braucht (ich bin gekommen, ich habe gemacht), packt das Türkische alles in ein Wort: erst die Zeitendung -dı/-di/-du/-dü (nach den stimmlosen ç, f, h, k, p, s, ş, t verhärtet sie zu -tı/-ti/-tu/-tü), dann die Personalendung — gel-di-m = „ich kam\". Ein grammatisches Geschlecht wie das deutsche er/sie/es gibt es nicht: o geldi heißt gleichermaßen „er kam\", „sie kam\" und „es kam\". Welcher Vokal in der Endung steht, richtet sich nach der Vokalharmonie, für die es im Deutschen keine Entsprechung gibt.",
   "ar_sy": "الماضي المعروف بنستعملو للأفعال المنتهية اللي الحكي شافها أو عاشها أو متأكد منها. بعكس العربي اللي بيميّز الذكر عن الأنثى (راح / راحت)، بالتركي ما في جنس أبداً: o gitti بتنقال للرجّال وللمرا وللشي سوا. وبعكس العربي اللي بيصرّف الفعل بأوزان وحروف جوّا الكلمة، التركي بس بيلزق كل شي عالجذر: أول شي لاحقة الزمن -dı/-di/-du/-dü (وبتصير -tı/-ti/-tu/-tü بعد حرف مهموس ç, f, h, k, p, s, ş, t)، وبعدين لاحقة الشخص، وبتطلع كلمة وحدة: gel-di-m يعني «أنا جيت». وأي حركة بتنحط باللاحقة بتتبع انسجام الحركات، وهاد الشي ما إلو مثيل بالعربي."
  },
  "tables": [
   {
    "caption": {
  ...
  "hints": {
   ...
   "de": "Typische Fehler Deutschsprachiger: (1) Sie suchen nach einem Hilfsverb wie im Perfekt — es heißt aber schlicht geldim, ein Wort, ohne haben/sein. (2) Sie vergessen die Verhärtung nach stimmlosem Konsonanten: richtig gitti, yaptım, ettim — nicht *gitdi, *yapdım. (3) Sie hängen eine feste Endung an alle Verben, statt sie per Vokalharmonie anzupassen (geldim, aber aldım, gördüm, okudum). Und verwechseln Sie -dı nicht mit -mış: -dı = „ich habe es selbst gesehen\", -mış = „man sagt / angeblich\".",
   "ar_sy": "غلطات شائعة عند العرب: (١) بيتوقعوا الفعل يتغير حسب الجنس متل بالعربي، بس o geldi وحدة للرجّال وللمرا. (٢) بينسوا القلب لـ-t- بعد الحرف المهموس: الصح gitti، yaptım، ettim مو *gitdi، *yapdım. (٣) بيلزقوا نفس اللاحقة لكل الأفعال بدل ما يتبعوا انسجام الحركات (geldim بس aldım، gördüm، okudum). وانتبه: -dı يعني «أنا شفت بعيني» بس -mış يعني «بيقولوا / عالأغلب»."
  }
 },
 {
  ...
  "intro": {
   ...
   "de": "Im Deutschen bildest du Ja/Nein-Fragen durch Umstellung — Subjekt und Verb tauschen den Platz: „Ist das dein Buch?\", „Bist du Student?\". Das Türkische stellt nichts um: Der Satz bleibt genau wie die Aussage, und du hängst nur die getrennt geschriebene Partikel mı an das erfragte Wort an (Bu senin kitabın mı?, Öğrenci misin?). Ihr Vokal richtet sich nach dem letzten Vokal davor — a/ı→mı, e/i→mi, o/u→mu, ö/ü→mü —, wofür es im Deutschen keine Entsprechung gibt. Die Personalendungen kleben an die Partikel selbst (miyim, misin), nicht ans Verb oder Substantiv.",
   "ar_sy": "بالعربي السوري مِنعمل سؤال نعم/لأ بالنبرة بس، وبنفس ترتيب الجملة: «هادا كتابك؟» — ما في أداة ولا قلب بترتيب الكلمات. بالتركي لازم تضيف الأداة mı، وبتنكتب لحالها منفصلة بس بتنلفظ ملزوقة بالكلمة اللي قبلها (Bu senin kitabın mı?، Öğrenci misin?). حرف العلة تبعها بيتغيّر حسب آخر حرف علة قبلها — a/ı→mı، e/i→mi، o/u→mu، ö/ü→mü — وهالشي ما إلو مثيل بالعربي. ولواحق الضمير بتنلزق عالأداة نفسها (miyim، misin)، مو عالفعل ولا عالاسم."
  },
  "tables": [
   {
    "caption": {
  ...
  "hints": {
   ...
   "de": "Deutschsprachige stellen reflexartig um („Bist du…?\") oder heben nur die Stimme und lassen mı ganz weg — ohne die Partikel klingt der türkische Satz aber wie eine Aussage, nicht wie eine Frage. Vergiss außerdem nicht, den Vokal anzupassen (zor mu?, evde mi?) und die Personalendung an die Partikel zu hängen (misin, miyim), nicht ans Hauptwort. Und achte auf die Stellung: „Sen mi geldin?\" (Bist DU gekommen?) und „Sen geldin mi?\" (Bist du gekommen?) sind verschiedene Fragen, weil die Partikel hinter verschiedenen Wörtern steht.",
   "ar_sy": "العربي بيميل يعمل السؤال بالنبرة بس وينسى الأداة mı — بس بدونها الجملة التركية بتضل خبر مو سؤال. ولا تحط شي متل «هل» بأول الجملة متل الفصحى؛ بالتركي الأداة بتجي بعد الكلمة اللي عم تسأل عنها. وانتبه تغيّر حرف العلة (zor mu?، evde mi?) وتلزق لاحقة الضمير عالأداة (misin، miyim) مو عالكلمة الأساسية، ودير بالك عالمكان: «Sen mi geldin?» (إنت اللي إجيت؟) غير «Sen geldin mi?» (إجيت؟)."
  }
 },
 {
  "id": "negation",
  ...
  "intro": {
   ...
   "de": "Anders als das Deutsche, das fast alles mit „nicht\" oder „kein\" verneint, kennt das Türkische kein einziges Allzweck-Wort: die Verneinung wird auf drei Arten gebildet, und welche du nimmst, hängt vom Prädikat ab. Ist das Prädikat ein Verb, steckt die Verneinung als Suffix -ma/-me mitten IM Wort (gitmek → gitme-), nicht als eigenes Wörtchen davor. Bei Nomen und Adjektiven („er ist Lehrer\", „ich bin müde\") kommt das getrennte Wort değil dahinter, und für „es gibt nicht / ist nicht vorhanden\" (kein Brot) nimmt man yok. Bestimme also zuerst die Art des Prädikats und wähle erst dann die passende Verneinungsform.",
   "ar_sy": "بالعكس عن العربي، يلي منفي فيه بـ«ما» أو «مو» لكل شي، التركي ما عندو كلمة نفي وحدة لكل الحالات: في ٣ طرق، وبتختار حسب الخبر بالجملة. إذا الخبر فعل، النفي بيجي كلاحقة -ma/-me جوّا الكلمة نفسها (gitmek → gitme-)، مو كلمة لحالها قبل الفعل. إذا الخبر اسم أو صفة («هو أستاذ»، «أنا تعبان») بتحط كلمة değil منفصلة بعدو، ولمعنى «ما في / مو موجود» (ما في خبز) بتستعمل yok. يعني أول شي شوف نوع الخبر، وبعدين اختار طريقة النفي."
  },
  "tables": [
   {
    "caption": {
  ...
  "hints": {
   ...
   "de": "Der typische Fehler deutscher Lerner: ein einzelnes „nicht\" als eigenes Wort vor das Verb zu setzen, wie in „ich gehe nicht\". Auf Türkisch geht das nicht — man sagt nie „değil gidiyorum\", sondern gitmiyorum, mit der Verneinung IM Verb. Merk dir außerdem: vor dem Präsens -yor wird das -ma/-me durch die Vokalharmonie zu -mı/-mi/-mu/-mü, also gitmiyor (nicht gitmayor) und okumuyor (nicht okumayor) — dafür gibt es im Deutschen kein Vorbild.",
   "ar_sy": "الغلط الشائع عند العرب: إنك تحط كلمة نفي لحالها قبل الفعل متل «ما» بالعربي، وتقول شي متل «değil gidiyorum». هاد غلط — الفعل بيننفى بلاحقة جوّا الكلمة: gitmiyorum مو değil gidiyorum. وكمان انتبه: قبل المضارع -yor، اللاحقة -ma/-me بتضيق حسب الانسجام الصوتي وبتصير -mı/-mi/-mu/-mü، فبتطلع gitmiyor (مو gitmayor) وokumuyor (مو okumayor) — وهالشي ما إلو مثيل بالعربي."
  }
 },
 {
  "id": "cases",
  ...
  "intro": {
   ...
   "de": "Ein Fall ist im Türkischen ein einziges Suffix, das hinten ans Wort geklebt wird und seine Rolle im Satz anzeigt — anders als im Deutschen, wo der Fall meist am Artikel (der/den/dem/des) und manchmal am Nomen sichtbar wird und grammatisches Geschlecht mitspielt. Türkisch hat weder Artikel noch Genus: Du wählst nur das passende Suffix und passt dessen Vokale per Vokalharmonie ans Wort an (dafür gibt es im Deutschen keine Entsprechung). Am sichersten fragst du: wo? = Lokativ (-da), woher? = Ablativ (-dan), wohin?/wem? = Dativ (-a), wen/was? (bestimmtes Objekt) = Akkusativ (-ı), wessen? = Genitiv (-ın). Endet das Wort auf einen Vokal, kommt ein Puffer-Buchstabe dazu: -y- (Akkusativ, Dativ) oder -n- (Genitiv): arabayı, arabaya, arabanın.",
   "ar_sy": "بالتركي الحالة هي لاحقة وحدة بتنلزق بآخر الكلمة وبتبيّن دورها بالجملة، مو متل العربي يلي بيستعمل حروف جر منفصلة (بـ، من، لـ) وإضافة. التركي ما فيه تذكير وتأنيث ولا أداة تعريف: بس بتختار اللاحقة المناسبة وبتظبّط حركاتها مع الكلمة حسب انسجام الحركات (شي ما إلو مثيل بالعربي). أضمن طريقة تسأل: وين؟ = المكان (-da)، من وين؟ = المصدر (-dan)، لوين؟/لمين؟ = الاتجاه (-a)، مين/شو؟ (مفعول معرّف) = المفعول (-ı)، لمين مُلك؟ = الإضافة (-ın). وإذا الكلمة بتنتهي بحرف علة، بينضاف حرف وصل: -y- (المفعول والاتجاه) أو -n- (الإضافة): arabayı، arabaya، arabanın."
  },
  "tables": [
   {
    "caption": {
  ...
  "hints": {
   ...
   "de": "Übertrage die deutschen Fälle nicht eins zu eins: „wohin?\" und „wem?\" sind im Türkischen derselbe Dativ -a/-e (eve = „nach Hause\", bana = „mir\"), obwohl das im Deutschen Akkusativ mit Präposition bzw. Dativ wäre. Der häufigste Fehler von Deutschsprachigen ist, den Akkusativ an jedes Objekt zu hängen — er kommt aber nur beim bestimmten Objekt (kitabı = „das Buch\"); ein unbestimmtes Objekt bleibt endungslos (bir kitap okuyorum = „ich lese ein Buch\"). Und: „wo?\" ist der Lokativ (-da), nicht der Dativ — verwechsle okulda („in der Schule\") nicht mit okula („zur Schule\").",
   "ar_sy": "ما تنقل حروف الجر العربية حرف بحرف عالتركي: «لوين؟» و«لمين؟» بالتركي نفس لاحقة الاتجاه -a/-e (eve = «عالبيت»، bana = «إلي»)، مع إنها بالعربي حرفين مختلفين. أكبر غلط بيعملو العرب إنو يحطّو لاحقة المفعول -ı على أي مفعول: بس هي بتجي مع المفعول المعرّف (kitabı = «الكتاب»)، أما النكرة فبيضل بدون لاحقة (bir kitap okuyorum = «عم اقرا كتاب»). وتذكّر: «وين؟» هي حالة المكان (-da) مو الاتجاه — ما تخلط okulda («بالمدرسة») مع okula («عالمدرسة»)."
  }
 },
 {
  "id": "aorist",
  ...
  "intro": {
   ...
   "de": "Das Aorist ist eine Zeitform, für die es im Deutschen keine eigene Entsprechung gibt – wir haben nur ein Präsens, das im Türkischen auf zwei Formen aufgeteilt wird. Das Aorist beschreibt nicht das, was gerade in diesem Moment abläuft (das ist -yor), sondern das, was allgemein gilt: Gewohnheiten, regelmäßig Wiederkehrendes, allgemeine Wahrheiten, aber auch Bereitschaft, Versprechen und höfliche Angebote oder Bitten. An den Verbstamm tritt -(a/ı)r (nach Vokal nur -r), wobei der Vokal der Vokalharmonie folgt – so etwas kennt das Deutsche nicht. Die Verneinung ist unregelmäßig: -maz/-mez, aber in der 1. Person -mam/-mem (ben gelmem, içmem).",
   "ar_sy": "الـ geniş zaman ما إلو مقابل مباشر بالعربي، لأنه بالعربي عنا مضارع واحد بيغطي كل شي، بس بالتركي بينقسم لصيغتين. هالزمن ما بيعبّر عن اللي عم يصير هلق بهاللحظة (هاد شغل -yor)، بيعبّر عن اللي بيصير بشكل عام: العادات، الأشياء اللي بتتكرر، الحقائق العامة، وكمان الاستعداد والوعد والعرض أو الطلب بأدب. بينضاف لجذر الفعل اللاحقة -(a/ı)r (بعد الحرف الصوتي بس -r)، والحرف الصوتي بيتبع الانسجام الصوتي – شي ما إلو وجود بالعربي. النفي شاذ: -maz/-mez، بس بصيغة المتكلم بيصير -mam/-mem (ben gelmem، içmem)."
  },
  "tables": [
   {
    "caption": {
  ...
  "hints": {
   ...
   "de": "Die Hauptfalle für Deutschsprachige: Unser einziges Präsens deckt beides ab, deshalb verwechselt man das Aorist leicht mit -yor. -yor heißt „gerade jetzt, in diesem Moment\" (şu an kahve içiyorum), das Aorist dagegen „im Allgemeinen, üblicherweise\" (her sabah kahve içerim) – bei jedem Satz muss man sich also neu entscheiden, was im Deutschen entfällt. Zweite Falle: die Verneinung der 1. Person ohne -z (içmem, gelmem, NICHT içmezim/gelmezim), und denk daran, dass „Çay içer misin?\" kein Frage nach der Gewohnheit ist, sondern ein höfliches Angebot: „Möchtest du einen Tee?\".",
   "ar_sy": "أكبر غلطة بيعملها العربي: بما إنه عنا مضارع واحد بيغطي الحالتين، منخلط بين الـ geniş والـ -yor. الـ -yor يعني „هلق بهاللحظة\" (şu an kahve içiyorum)، والـ geniş يعني „بشكل عام، عادةً\" (her sabah kahve içerim)، فبكل جملة لازم تختار، وهاد شي ما منعملو بالعربي. الغلطة التانية: نفي صيغة المتكلم بدون -z (içmem، gelmem، مو içmezim/gelmezim)، وتذكّر إنه „Çay içer misin?\" مو سؤال عن عادتك، هي عرض بأدب يعني „بتشرب شاي؟\"."
  }
 },
 {
  "id": "past-reported",
  ...
  "intro": {
   ...
   "de": "Das Suffix -mış setzt du, wenn du bei einem Ereignis nicht selbst dabei warst: du hast es von jemandem gehört, aus Spuren erschlossen, erst jetzt bemerkt oder es überrascht dich. Im Deutschen gibt es dafür keine eigene Verbform — du behilfst dir mit Adverbien (angeblich, offenbar, anscheinend) oder mit dem Konjunktiv I der indirekten Rede; im Türkischen steckt diese Bedeutung direkt im Verb. Vergleiche: gittim heißt \"ich bin gefahren\" (ich war dabei, ich weiß es), aber gitmiş heißt \"er ist offenbar / soll gefahren sein\" (man hat es mir erzählt oder ich schließe es aus Anzeichen). Anders als die gesehene Vergangenheit auf -dı sagt die Form auf -mış also ausdrücklich, dass du für das Ereignis nicht persönlich einstehst.",
   "ar_sy": "منستعمل لاحقة -mış لما ما تكون شفت الشي بعينك: يا سمعتو من حدا، يا استنتجتو من آثار، يا انتبهتلو هلق، يا فاجأك. بالعربي ما في تصريف خاص للفعل مشان هيك — منزيد كلمة برّا الفعل متل \"بيقولوا\"، \"يظهر\"، \"مبيّن\"، أو منقول \"قال إنو\"؛ بس بالتركي المعنى هاد بينحط جوّا الفعل نفسو. قارن: gittim يعني \"أنا رحت\" (كنت موجود ومتأكد)، بس gitmiş يعني \"يظهر / بيقولوا راح\" (حدا حكالي أو استنتجت من الأدلة). عكس الماضي المشهود بـ-dı، الشكل بـ-mış بيقول صراحةً إنك مو ضامن الحدث بشكل شخصي."
  },
  "tables": [
   {
    "caption": {
  ...
  "hints": {
   ...
   "de": "Weil das Deutsche keine eigene Verbform für Hörensagen hat, greifen deutsche Muttersprachler aus Gewohnheit auch dort zu -dı, wo sie das Ereignis nur gehört oder erschlossen haben — dort gehört aber -mış hin. Merkregel: selbst gesehen → -dı; fremde Worte weitergegeben, über die eigene frühe Kindheit gesprochen oder aus Spuren geschlossen → -mış. Denk außerdem an die vier Vokalvarianten (-mış/-miş/-muş/-müş nach Vokalharmonie) und daran, dass die 3. Person Singular keine Personalendung bekommt: es heißt gelmiş, nicht \"gelmişo\".",
   "ar_sy": "لأنو العربي ما فيه تصريف خاص للنقل، العربي بيميل يستعمل -dı حتى بالحالات يلي بس سمع فيها أو استنتجها — بس هون لازم -mış. القاعدة: شفت بعينك → -dı؛ نقلت كلام غيرك، حكيت عن طفولتك يلي ما بتتذكرها، أو استنتجت من آثار → -mış. وانتبه لأربع أشكال للحركة (-mış/-miş/-muş/-müş حسب تناسق الحركات)، وإنو الغايب المفرد (o) ما بياخد لاحقة ضمير: منقول gelmiş مو \"gelmişo\"."
  }
 },
 {
  "id": "future",
  ...
  "intro": {
   ...
   "de": "Das Futur beschreibt Handlungen, die später geschehen. Anders als im Deutschen gibt es keine Wahl zwischen »werden« + Infinitiv und einem bloßen Präsens mit Zeitangabe — das Türkische hat genau EINE Endung, die an den Verbstamm tritt: -ecek nach hellen Vokalen (e, i, ö, ü), -acak nach dunklen (a, ı, o, u); endet der Stamm auf einen Vokal, schiebt sich ein -y- dazwischen (bekle → bekleyecek). Danach folgt die Personalendung, und hier lauert die Hauptfalle: vor vokalisch beginnenden Endungen (-im bei »ich«, -iz bei »wir«) wird das auslautende k zu ğ — geleceğim, geleceğiz; bei »du/ihr« folgt ein Konsonant, also bleibt das k stehen: geleceksin.",
   "ar_sy": "زمن المستقبل بيحكي عن شغلات رح تصير بعدين. بس مو متل العربي اللي بتحط كلمة لحالها متل «رح» قبل الفعل — بالتركي في لاحقة وحدة بس بتلزق بآخر الفعل: -ecek بعد الحركات (e, i, ö, ü) و -acak بعد (a, ı, o, u) حسب انسجام الحركات، وإذا الفعل بينتهي بحركة منحط -y- بالنص (bekle → bekleyecek). وبعدها بتجي لاحقة الضمير، وهون أكبر غلطة: قبل لاحقة بتبلّش بحركة (-im لـ«أنا»، -iz لـ«نحنا») الـ k بيصير ğ — geleceğim، geleceğiz؛ بس مع «إنت/إنتو» بيجي حرف ساكن، فالـ k بيضل: geleceksin. ولاحظ كمان إنو الفعل عادةً بيجي بآخر الجملة."
  },
  "tables": [
   {
    "caption": {
  ...
  "hints": {
   ...
   "de": "Deutschsprachige greifen fürs Türkische gern zum Präsens (»morgen gehe ich«), aber die Endung -(y)ecek/-(y)acak ist hier Pflicht — das bloße Präsens reicht nicht. Zweite typische Panne: das k→ğ vergessen — es heißt geleceğim und alacağım, nicht »gelecekim / alacakım«. Diese Erweichung passiert NUR bei »ich« und »wir« (Endung beginnt mit Vokal); bei »du/ihr« bleibt das k: geleceksin, geleceksiniz.",
   "ar_sy": "أكبر غلطتين لعرب: أول شي بيدوّروا على كلمة لحالها متل «رح» وبينسوا اللاحقة — بالتركي المستقبل أساسو اللاحقة -(y)ecek/-(y)acak الملزوقة بالفعل، مو كلمة منفصلة. وتاني شي بينسوا تليين الـ k: منقول geleceğim و alacağım مو «gelecekim / alacakım»، وهاد بيصير بس مع «أنا» و«نحنا»، بس مع «إنت/إنتو» الـ k بيضل. وما تغيّر الفعل حسب مذكّر/مؤنث زي العربي — «هو» و«هي» نفس الشي: gelecek."
  }
 },
 {
  "id": "postpositions",
  ...
  "intro": {
   ...
   "de": "Anders als deutsche Präpositionen (mit, für, nach) steht eine türkische Postposition IMMER hinter dem Wort, zu dem sie gehört: nicht „mit meiner Mutter\", sondern annemle (Mutter + ile). Manche Postpositionen (ile, için, gibi, kadar) nehmen das Nomen in der Grundform, ganz ohne Endung — öğrenci için (für den Studenten), aslan gibi (wie ein Löwe); andere verlangen einen Fall, den das Türkische als Suffix ans Wort hängt: sonra/önce fordern den Ablativ -den (dersten sonra = nach dem Unterricht), und kadar im Sinne von „bis\" den Dativ -e (eve kadar = bis nach Hause). Achtung bei Pronomen: ile/için/gibi stehen dort nicht mit der Grundform, sondern mit dem Genitiv — benim için (für mich), nicht „ben için\", und ile verschmilzt lautharmonisch oft zu -le/-la (benimle, otobüsle), was es im Deutschen so nicht gibt.",
   "ar_sy": "بالتركي، عكس العربي يلي حرف الجر بيجي قبل الاسم (مع، لأجل، بعد)، الأداة بتجي دايماً بعد الكلمة: مو \"مع إمي\" بل annemle (إم + ile). في أدوات (ile, için, gibi, kadar) بتاخد الكلمة بصيغتها المجردة بدون أي لاحقة — öğrenci için (للطالب)، aslan gibi (متل الأسد؛ ولاحظ ما في تعريف متل \"الـ\")؛ وأدوات تانية بدها حالة، والتركي بيلزقها كلاحقة عالكلمة مو كحرف منفصل: sonra/önce بدهن حالة الـ -den (dersten sonra = بعد الدرس)، وkadar بمعنى \"لحد\" بدها حالة الـ -e (eve kadar = لحد البيت). دير بالك مع الضمائر: ile/için/gibi ما بياخدوا الصيغة المجردة بل صيغة الإضافة — benim için (لأجلي)، مو \"ben için\"، وile كتير بتلتصق وبتتغير حسب انسجام الحركات لـ -le/-la (benimle، otobüsle)."
  },
  "tables": [
   {
    "caption": {
  ...
  "hints": {
   ...
   "de": "Merke dir die Spiegelung: Wo im Deutschen die Präposition VOR dem Wort steht, kommt im Türkischen die Postposition dahinter. Der häufigste Fehler ist, sonra/önce mit dem „nackten\" Wort zu benutzen — sie brauchen den Ablativ -den: yemekten sonra (nach dem Essen), nicht „yemek sonra\". Und bei Pronomen unbedingt den Genitiv nehmen: benim için, benim gibi, benimle — nicht „ben için\" oder „ben gibi\"; unterscheide außerdem die zwei kadar: „so viel wie\" (benim kadar) und „bis\" mit Dativ (akşama kadar).",
   "ar_sy": "تذكّر الانعكاس: بالعربي حرف الجر بيجي قبل الكلمة، بس بالتركي الأداة بتجي بعدها. أكبر غلط إنك تحط sonra/önce مع الكلمة \"عارية\" — بدهن حالة الـ -den: yemekten sonra (بعد الأكل)، مو \"yemek sonra\". ومع الضمائر لازم صيغة الإضافة: benim için، benim gibi، benimle — مو \"ben için\" ولا \"ben gibi\"؛ وفرّق بين الـ kadar لتنين: \"قد\" (benim kadar) و\"لحد\" مع حالة الـ -e (akşama kadar)."
  }
 },
 {
  "id": "comparatives",
  ...
  "intro": {
   ...
   "de": "Im Türkischen wird das Adjektiv NIE gesteigert - es gibt keine Formen wie im Deutschen (groß → größer → am größten). Das Adjektiv bleibt unverändert; man stellt einfach daha ('mehr') oder en ('am meisten') davor: daha büyük (größer), en büyük (am größten). Das Vergleichsobjekt bekommt kein eigenes Wort wie deutsches 'als', sondern die Ablativendung -dan/-den und steht VORNE: benden uzun (wörtlich 'von-mir groß' = größer als ich); daha ist dann optional. Gleichheit ('so … wie') drückt kadar aus: benim kadar çalışkan (so fleißig wie ich).",
   "ar_sy": "بالتركي الصفة ما بتتغير أبداً - ما في صيغة أفعل متل بالعربي (كبير ← أكبر). الصفة بتضل متل ما هي، وبس بتحط قبلها daha (يعني 'أكتر') أو en (يعني 'الأكتر'): daha büyük (أكبر)، en büyük (الأكبر). الشي يلي عم تقارن فيه ما بياخد كلمة لحالها متل 'من' بالعربي، لأ بياخد لاحقة المصدر ‑dan/‑den وبيجي قبل الصفة: benden uzun (حرفياً 'مني طويل' = أطول مني)، وهون daha اختيارية. للمساواة منستعمل kadar: benim kadar çalışkan (مجتهد قدّي)."
  },
  "tables": [
   {
    "caption": {
  ...
  "hints": {
   ...
   "de": "Der typische Fehler: das Adjektiv selbst steigern zu wollen (uzunER o.Ä.) - das gibt es im Türkischen nicht, es bleibt uzun. Suchen Sie auch kein Wort für 'als': es ist die Endung -dan/-den, die VOR dem Adjektiv steht (benden uzun, nicht 'uzun benden'). Vor en (Superlativ) niemals daha setzen, und Achtung bei kadar - mit Pronomen braucht es den Genitiv (benim kadar, senin kadar, onun kadar), mit Namen/Nomen dagegen ohne Endung (Ahmet kadar).",
   "ar_sy": "الغلط الشائع إنك تدوّر على كلمة لـ 'من' وتحطها بعد الصفة متل بالعربي؛ بالتركي 'من' هي لاحقة ‑dan/‑den وبتيجي قبل الصفة (benden uzun مش 'uzun benden'). وما تحاول تغيّر الصفة نفسها - بتضل uzun، والمعنى بيجي من daha أو en. قبل en (التفضيل) ولا مرة تحط daha، وانتبه لـ kadar: مع الضمير بتاخد صيغة الملكية (benim kadar، senin kadar، onun kadar)، بس مع الاسم بلا لاحقة (Ahmet kadar)."
  }
 },
 {
  ...
  "intro": {
   ...
   "de": "Im Türkischen bekommt der Imperativ für „du\" keine Endung — man nimmt einfach den nackten Verbstamm: gel! = komm!, otur! = setz dich!. Anders als das Deutsche, das mit „komm / kommt / kommen Sie\" auskommt und für „er soll kommen\" oder „lass uns gehen\" zusätzliche Wörter braucht, hat das Türkische für jede Person eine eigene Endung direkt am Verb: gel (du), gelin (ihr/Sie), gelsin (er/sie soll kommen), gelsinler (sie sollen kommen). Für „ich\" und „wir\" dient der Optativ -eyim / -elim: gideyim = ich will/soll mal gehen, gidelim = lass uns gehen. Wo das Deutsche also „soll\" oder „lass uns\" einschiebt, steckt das Türkische alles in eine einzige Endung.",
   "ar_sy": "بالتركي صيغة الأمر لـ«إنت» ما إلها لاحقة نهائي — بتاخد الفعل عارِي متل ما هو: gel! = تعا!، otur! = اقعُد!. بس مو متل العربي يلي بيميّز بس بين المذكّر والمؤنث (تعا / تعي)، التركي ما بيفرّق بين ذكر وأنثى أبداً، وبالمقابل بيعطي لكل شخص لاحقة لحاله ملصوقة عالفعل: gel (إنت)، gelin (إنتو / محترم)، gelsin (خلّيه يجي)، gelsinler (خلّيهن يجوا). ولـ«أنا» و«نحنا» في صيغة الطلب -eyim / -elim: gideyim = خلّيني روح، gidelim = يلّا نروح. يعني محل ما العربي بيحط كلمة زيادة متل «خلّي» أو «يلّا»، التركي بيدبّرها بلاحقة وحدة عالفعل."
  },
  "tables": [
   {
    "caption": {
  ...
  "hints": {
   ...
   "de": "Der Hauptfehler: Deutschsprachige übertragen ihr knappes System (komm / kommt) und benutzen die endungslose Form gel, otur auch gegenüber Fremden, Älteren oder in höflichen Bitten — das klingt schroff, dort gehört -in hin (gelin, oturun). Die 3. Person gelsin nicht mit „er kommt\" verwechseln, sondern als „er soll kommen\" verstehen, und bei -eyim / -elim das Personalpronomen ben/biz weglassen — die Person steckt schon in der Endung. Achte außerdem auf den Konsonantenwechsel: git → gidin, gideyim (vor Vokal wird t zu d), aber gitsin (vor Konsonant bleibt t).",
   "ar_sy": "أكبر غلط عند العربي: بيستعمل الفعل العاري (gel, otur) مع أي حدا، بس هاد بس لـ«إنت» وبين المقرّبين — مع غريب أو أكبر بالعمر أو بطلب مؤدّب بيصير خشِن، لازم تضيف -in (gelin, oturun). كمان صيغة الغايب gelsin ما إلها مقابل مباشر بالعربي، فترجمها «خلّي + فعل» (خلّيه يجي)، و-eyim / -elim قابلها بـ«يلّا نـ...» أو «خلّيني...» بلا ما تحط ضمير أنا/نحنا لأنّه الشخص أصلاً بايِن باللاحقة. وانتبه لتبدّل الحرف: git بتصير gidin وgideyim (قبل حرف علّة t بتصير d)، بس gitsin بتضلّ t."
  }
 },
 {
  "id": "izafet",
  ...
  "intro": {
   ...
   "de": "Ein İzafet verbindet zwei Substantive. Beim unbestimmten İzafet bekommt nur das zweite (Kopf-)Nomen die Endung -(s)I und benennt eine Art Sache, ähnlich wie das deutsche Kompositum „Tomatensuppe\" — nur wird im Türkischen nicht zusammengeschrieben, sondern das zweite Wort markiert: domates çorbası. Beim bestimmten İzafet drückt man konkreten Besitz aus; dann steht das erste Nomen zusätzlich im Genitiv -(n)In (Ali'nin evi „Alis Haus\"). Anders als im Deutschen, wo nur der Besitzer eine Endung (-s) trägt oder „von\" davor steht, markiert das Türkische beide Wörter — den Besitzer mit -(n)In und die besessene Sache mit -(s)I; welche Vokalvariante die Endung annimmt, richtet sich nach der Vokalharmonie (evi, kızı, okulu, gözü).",
   "ar_sy": "الإضافة بتربط اسمين مع بعض. بالإضافة غير المعرّفة، الاسم التاني بس بياخد لاحقة -(s)I وبتدل على نوع الشي، متل ما بالعربي منقول «شوربة بندورة» — بس بالتركي اللاحقة بتنحط عالاسم التاني: domates çorbası. بالإضافة المعرّفة، لما يكون في مالك محدد، الاسم الأول كمان بياخد لاحقة الجر -(n)In (Ali'nin evi يعني بيت علي). الفرق عن العربي: بالعربي بنقول «بيت علي» والاسم الأول بس بيتغير أو بيبقى متل ما هو، بس بالتركي لازم تحط علامة عالكلمتين — المالك بياخد -(n)In والشي المملوك بياخد -(s)I، وشكل حركة اللاحقة بيتبع انسجام الحركات (evi، kızı، okulu، gözü)، وما في مذكر ومؤنث متل العربي."
  },
  "tables": [
   {
    "caption": {
  ...
  "hints": {
   ...
   "de": "Typischer Fehler von Deutschsprachigen: Sie denken in Komposita („Tomatensuppe\" = ein Wort) und lassen die Endung am zweiten Nomen weg — es heißt aber immer domates çorbası, nie domates çorba. Und verwechseln Sie die zwei İzafet-Typen nicht: konkreter Besitzer → Genitiv am ersten Wort (Ali'nin evi); bloß eine Art Sache → nur -(s)I ohne Genitiv (otobüs durağı, nicht otobüsün durağı).",
   "ar_sy": "الغلط الشائع عند العرب: منقول «بيت علي» ومنحط علامة عالمالك بس، فبننسى لاحقة -(s)I عالاسم التاني ومنقول Ali'nin ev بدل Ali'nin evi، أو domates çorba بدل domates çorbası. خليك منتبه: إذا في مالك محدد لازم -(n)In عالكلمة الأولى مع -(s)I عالتانية (Ali'nin evi)؛ إذا بس نوع شي، بس -(s)I بلا جر (otobüs durağı، مو otobüsün durağı)."
  }
 },
 {
  ...
  "intro": {
   ...
   "de": "-abil/-ebil wird direkt in das Verb eingebaut und bedeutet „können\" oder „möglich sein\" — anders als im Deutschen gibt es kein eigenständiges Modalverb wie „können\", das neben dem Vollverb steht. Die Verneinung ist unregelmäßig: nicht das normale „nicht\" (-me), sondern die Sonderform -ama/-eme (gelemem — „ich kann nicht kommen\"). -meli/-malı drückt Notwendigkeit aus und entspricht deutsch „müssen / sollen\" (gitmeliyim — „ich muss gehen\"); auch das steckt als Suffix im Verb, nicht als extra Wort.",
   "ar_sy": "-abil/-ebil بينحط جوّا الفعل نفسو ومعناتو \"بقدر\" أو \"ممكن\" — مو متل العربي إنو في كلمة لحالها متل \"فيني/بقدر\". النفي إلو صيغة خاصة، مو النفي العادي (-me)، منستعمل -ama/-eme (gelemem — \"ما فيّي إجي\"). و-meli/-malı بيعبّر عن الضرورة ومعناتو \"لازم\" (gitmeliyim — \"لازم روح\")، وهاد كمان لاحقة جوّا الفعل مو كلمة لحال."
  },
  "tables": [
   {
    "caption": {
  ...
  "hints": {
   ...
   "de": "Im Deutschen sind „können\" und „müssen\" eigene Wörter, im Türkischen kleben sie als Suffix am Verb — versuchen Sie also nicht, ein extra Modalwort einzusetzen. Drei Fallen: (1) „nicht können\" ist nicht das reguläre -me, sondern die Sonderform -ama/-eme (gelemem, nicht „gelmeyebilirim\"); (2) in der 1. Person Singular fällt das -z weg: richtig ist gelemem, nicht „gelemezim\"; (3) bei -meli kommt vor der Personalendung ein Bindekonsonant -y-: gitmeliyim, nicht „gitmelim\".",
   "ar_sy": "بالعربي \"بقدر\" و\"لازم\" كلمات لحالهن، بس بالتركي بينحطوا كلاحقة جوّا الفعل، فما تحاول تحط كلمة زيادة. تلت غلطات لازم تنتبهلن: (١) نفي \"بقدر\" مو بالنفي العادي -me، لأ صيغة خاصة -ama/-eme (gelemem مو \"gelmeyebilirim\")؛ (٢) بصيغة المتكلم المفرد بينوقع الـ-z: الصح gelemem مو \"gelemezim\"؛ (٣) مع -meli بيجي حرف وصل -y- قبل لاحقة الشخص: gitmeliyim مو \"gitmelim\"."
  }
 },
 {
  "id": "conditional",
  ...
  "intro": {
   ...
   "de": "Im Türkischen steckt die Bedingung im Verb selbst: Das Suffix -se/-sa (nach hellen Vokalen -se, nach dunklen -sa — das ist die Vokalharmonie, für die es im Deutschen keine Entsprechung gibt) hängt sich an den Verbstamm und bedeutet schon allein \"wenn\". Für reale, gut mögliche Bedingungen kombiniert man es mit dem Aorist: gel-ir + -se → gelirse (\"wenn er kommt\"). Das nackte -se/-sa ohne Aorist, etwa gelse, drückt dagegen einen Wunsch oder eine irreale Bedingung aus (\"wäre er doch da\"). Anders als das deutsche freistehende \"wenn/falls\" ist das türkische eğer nur eine optionale Verstärkung am Satzanfang — die eigentliche Bedingung trägt das Suffix.",
   "ar_sy": "بالتركي الشرط بينحط جوّا الفعل نفسو: اللاحقة -se/-sa (بعد الحركات الرقيقة بتصير -se وبعد الغليظة -sa، وهاد اسمو انسجام الحركات وما في متلو بالعربي) بتنلزق بجذر الفعل ومعناها لحالها \"إذا\". للحالات الممكنة الحقيقية بتندمج مع صيغة المضارع الواسع: gel-ir + -se ← gelirse يعني \"إذا إجا\". أما -se/-sa لحالها بدون المضارع، متل gelse، فبتعني تمنّي أو شي مستحيل (\"يا ريتو هون\"). وعكس \"إذا\" و\"لو\" بالعربي يلي بيوقفوا ككلمة لحال، كلمة eğer بالتركي مجرّد تأكيد اختياري بأول الجملة — المعنى الأساسي محمول باللاحقة."
  },
  "tables": [
   {
    "caption": {
  ...
  "hints": {
   ...
   "de": "Typischer Fehler deutscher Lerner: eğer sagen, aber das Verb in der normalen Form stehen lassen — im Türkischen ist das Suffix -se/-sa Pflicht, eğer nur optionale Zugabe. Und verwechseln Sie die zwei Formen nicht: -irse ist die reale Bedingung (\"wenn du anrufst, komme ich\"), während das bloße -se/-sa Wunsch oder Irreales ausdrückt (\"wäre ich doch da\", \"hätte ich Geld\") — oft mit keşke (\"wenn doch\") verstärkt.",
   "ar_sy": "غلط شائع عند العرب: تقول eğer وتترك الفعل بصيغتو العادية — بالتركي اللاحقة -se/-sa ضرورية وفرض، وeğer بس زيادة اختيارية فيك تشيلها. وانتبه ما تخلط بين الصيغتين: -irse للحالة الممكنة الحقيقية (\"إذا اتصلت، بجي\")، و-se/-sa لحالها للتمنّي أو المستحيل (\"يا ريتني هون\"، \"لو معي مصاري\") — وكتير بيزيدوا معها كلمة keşke يعني \"يا ريت\"."
  }
 },
 {
  "id": "converbs",
  ...
  "intro": {
   ...
   "de": "Die Konverb-Form ersetzt im Türkischen einen ganzen Nebensatz: Die Bedeutung der Konjunktion steckt bereits im Suffix des Verbs, deshalb braucht man kein zusätzliches „während“, „wenn“ oder „und“. -ken heißt „während / solange“ (gleichzeitige Handlung), -ince „wenn / sobald“ (die zweite Handlung folgt direkt), -erek/-arak „indem / dadurch, dass …“ (Art und Weise) und -ip „und (dann)“ (Abfolge). Anders als im Deutschen, wo der Nebensatz ein eigenes finites Verb mit Personalendung hat, steht der türkische Konverb-Ausdruck immer vor dem Hauptverb und wird selbst nicht nach Person konjugiert — die Person legt allein das Hauptverb fest.",
   "ar_sy": "صيغة الربط بالتركي بتعوّض عن جملة تابعة كاملة: معنى أداة الربط صار جوّا لاحقة الفعل، فمنشان هيك ما بدك أداة زيادة مثل «وقت» أو «لمّا» أو «و». ‏-ken يعني «بينما / طول ما» (فعلين بنفس الوقت)، و‏-ince يعني «لمّا / بمجرد ما» (الفعل التاني بيجي عالطول بعد الأول)، و‏-erek/-arak يعني «عن طريق / وهو عم» (طريقة العمل)، و‏-ip يعني «و بعدين» (تسلسل). وبعكس العربي يلي فيه الفعل بالجملة التابعة بينصرف حسب الفاعل، هون صيغة الربط دايماً بتجي قبل الفعل الرئيسي وما بتتصرّف حسب الشخص — الشخص بيحدّدو بس الفعل الرئيسي."
  },
  "tables": [
   {
    "caption": {
  ...
  "hints": {
   ...
   "de": "Im Deutschen braucht man Konjunktion (während / wenn / indem / und) plus ein finites Verb — im Türkischen entfällt die Konjunktion völlig, ihre Bedeutung liegt allein im Suffix. Drei typische Fehler von Deutschsprachigen: (1) -ken wird an den Infinitiv oder Stamm gehängt, obwohl es an den Aorist tritt: gel-ir → gelirken, nicht „gelken“; (2) man setzt aus Gewohnheit noch ein „und/während/wenn“ dazu, das im Türkischen schon im Suffix steckt und daher doppelt wäre; (3) man vergisst, dass -erek/-arak und -ip dasselbe Subjekt in beiden Teilen verlangen, während -ince und -ken auch ein anderes Subjekt zulassen.",
   "ar_sy": "بالعربي لازم أداة ربط (وقت، لمّا، وهو عم، و) مع فعل مستقل بينصرف حسب الفاعل، بس بالتركي ما في أداة أبداً والمعنى كلّو جوّا اللاحقة، والجملة الفرعية بتجي قبل الفعل الرئيسي. تلات غلطات شائعة عند العرب: (١) بيلزقوا ‏-ken عالمصدر أو عالجذر، بس هي بتنضاف عالمضارع العام: gel-ir ← gelirken مو «gelken»؛ (٢) بيزيدوا أداة ربط مثل «و» أو «لمّا» من عادة العربي، بس هي أصلاً موجودة بللاحقة وبتصير مكررة؛ (٣) بينسوا إنو ‏-erek/-arak و‏-ip لازم يكون الفاعل نفسو بالجملتين، بينما ‏-ince و‏-ken بيسمحوا بفاعل مختلف."
  }
 },
 {
  "id": "participles",
  ...
  "intro": {
   ...
   "de": "Das Türkische kennt kein Relativpronomen wie „der/die/das\" — der ganze Nebensatz schrumpft zu einem einzigen Wort, das wie ein Adjektiv VOR das Nomen tritt (im Deutschen steht der Relativsatz danach, mit Komma). Entscheidend ist die Rolle des Nomens: Ist es das Subjekt (es handelt selbst), nimmst du -en/-an — okuyan adam „der Mann, der liest\". Ist es das Objekt (die Handlung trifft es), nimmst du -dik (Vergangenheit/Gegenwart) oder -ecek (Zukunft) plus Possessivsuffix, und der Handelnde steht im Genitiv: (benim) okuduğum kitap „das Buch, das ich lese/gelesen habe\". Achte auf die Vokalharmonie (okuduğum, gördüğüm, yaptığım) — dafür gibt es im Deutschen keine Entsprechung.",
   "ar_sy": "بالتركي ما في ضمير وصل متل „اللي\" بالعربي، والجملة كلّها بتصير كلمة وحدة بتنحطّ قبل الاسم متل الصفة (مو بعدو متل ما بالعربي منقول „الرجّال اللي عم يقرا\"). الأهم إنك تعرف دور الاسم: إذا هوّي الفاعل (عم يعمل الشي بنفسو) بتستعمل -en/-an — okuyan adam „الرجّال اللي عم يقرا\". وإذا هوّي المفعول (الفعل واقع عليه) بتستعمل -dik للماضي/الحاضر أو -ecek للمستقبل مع لاحقة ملكية، والفاعل بيجي بحالة الإضافة (المضاف إليه): (benim) okuduğum kitap „الكتاب اللي أنا عم اقراه/قريتو\". وانتبه للانسجام الصوتي (okuduğum، gördüğüm، yaptığım) — شي ما إلو مثيل بالعربي."
  },
  "tables": [
   {
    "caption": {
  ...
  "hints": {
   ...
   "de": "Such kein Wort für „der/die/das\" — es gibt keins, und das Partizip steht VOR dem Nomen, nicht dahinter wie der deutsche Relativsatz. Häufigster Fehler: -en/-an nehmen, obwohl das Nomen in Wirklichkeit das Objekt ist — gören adam heißt „der Mann, der sieht\", aber „der Mann, den ich sehe\" ist gördüğüm adam. Und der Handelnde wird kein eigenes Wort, sondern steckt im Possessivsuffix (-um/-un/-u) plus Genitiv: benim yaptığım, nicht „ben yapan\".",
   "ar_sy": "ما تدوّر على كلمة متل „اللي\" — ما في، والصفة بتيجي قبل الاسم مو بعدو. أكبر غلط بيعملو العرب: يستعملو -en/-an والاسم بالحقيقة مفعول — gören adam يعني „الرجّال اللي عم يشوف\"، بس „الرجّال اللي أنا عم شوفو\" بتصير gördüğüm adam. والفاعل ما بيصير كلمة لحالها، بيندسّ باللاحقة الملكية (-um/-un/-u) مع حالة الإضافة: benim yaptığım، مو „ben yapan\"."
  }
 },
 {
  "id": "voices",
  ...
  "intro": {
   ...
   "de": "Im Türkischen steckt das Genus Verbi nicht in einem Hilfswort, sondern in einem Suffix direkt am Verbstamm — und genau darin liegt der Unterschied zum Deutschen. Es gibt vier: Kausativ (yaptırmak „machen/veranlassen, dass jemand etwas tut“), Passiv (yapılmak „gemacht werden“), Reflexiv (yıkanmak „sich waschen“) und Reziprok/Kooperativ (görüşmek „sich sehen/treffen“). Wo das Deutsche zwei Wörter braucht („ließ die Schüler lesen“), presst das Türkische das oft in ein einziges agglutiniertes Verb (okuttu), und mehrere Suffixe können sogar hintereinander stehen: yap-tır-ıl-mak.",
   "ar_sy": "بالتركي صوت الفعل ما بيتغيّر بوزن جديد للجذر متل العربي، بيتغيّر بلاحقة بتنضاف عآخر الفعل — وهون الفرق الكبير. في أربع أصوات: السببي (yaptırmak يعني تخلّي حدا يعمل شي)، والمبني للمجهول (yapılmak انعمل)، والانعكاسي (yıkanmak يغسل حالو)، والتشاركي (görüşmek يشوفوا بعض). مطرح ما بالعربي منغيّر الوزن (غسل ← اغتسل، عمل ← انعمل)، بالتركي الجذر بيضل هو هو ومنركّب اللاحقة عليه، وحتى فينا نركّب أكتر من لاحقة ورا بعض: yap-tır-ıl-mak."
  },
  "tables": [
   {
    "caption": {
  ...
  "hints": {
   ...
   "de": "Deutschsprachige greifen reflexartig zum Hilfswort (lassen, werden, sich) und vergessen dann das eigentlich nötige Suffix am Verb — im Türkischen trägt der Verbstamm die ganze Last allein. Zweite Falle: Reflexiv (-In, yıkanmak „sich waschen“) und Passiv (-Il, yapılmak „gemacht werden“) sehen fast gleich aus; sie werden nicht an der Form, sondern nur an der Bedeutung auseinandergehalten. Und „ließ lesen“ ist kein Verb + Verb, sondern ein einziges Kausativverb: okuttu.",
   "ar_sy": "اللي بيحكي عربي بيتعوّد يغيّر وزن الفعل (فعّل، أفعل، انفعل، افتعل)، فبيدوّر عشي شكل داخلي بالتركي وما في — لازم بس تركّب اللاحقة والجذر بيضل زي ما هو. غلطة تانية: الانعكاسي (-In متل yıkanmak) والمجهول (-Il متل yapılmak) بيشبهوا بعض كتير، بس ما بتفرقهن بالشكل، بتفرقهن بالمعنى. وانتبه: «خلّى يقرا» مو فعلين، بالتركي فعل واحد سببي okuttu، ما بدها كلمة زيادة."
  }
 }
];
